...
Shader "Terrain_(-89.38, 2.09, -799.27)"
{
   Properties
   {
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/Terrain_(-89.38, 2.09, -799.27)_Base780762602"
   Fallback "Hidden/Terrain_(-89.38, 2.09, -799.27)_Base780762602"
