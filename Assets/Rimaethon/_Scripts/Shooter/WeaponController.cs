...
public class WeaponController : MonoBehaviour
{
    ...
    {
        EventManager.Instance.AddHandler<int>(GameEvents.OnPlayerCycleWeapon, HandlePlayerCycleWeapon);
        EventManager.Instance.AddHandler(GameEvents.OnPlayerClick, HandlePlayerClick);
    }

    private void OnDisable()
    {
        if (EventManager.Instance == null) return;
        EventManager.Instance.RemoveHandler<int>(GameEvents.OnPlayerCycleWeapon, HandlePlayerCycleWeapon);
        EventManager.Instance.RemoveHandler(GameEvents.OnPlayerClick, HandlePlayerClick);
    }
    ...
    public void HandlePlayerCycleWeapon(int value)
    {
        CycleEquippedGun();
    }
